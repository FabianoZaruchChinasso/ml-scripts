...
- fill-last: fill empty (NaN) values in a column or list of columns with the last non-empty value (forward fill). If the first row is empty, use the optional directive value as the default fallback.
